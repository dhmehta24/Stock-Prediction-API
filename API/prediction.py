...
def import_data(name):
    ...
    model = keras.models.load_model('stock_trailtwo_prediction_model')
    ...
    plt.plot(ndf['Prediction Results'], linewidth=3, color='purple')
    #plt.plot(new_close_df['Predicted Close'], linewidth=3, color='orange')

    #plt.legend(['Test Close', 'Prediction'], loc='upper left')
    plt.savefig('{}_future_stock_price_prediction.png'.format(name), dpi=100)
    plt.show()"""
